...
import { Terrain, riverX, riverLevel } from './Terrain.js?v=20260921163240';
import {
  buildTerrainTile, buildRiverMesh, buildRiverEdge, lodForDistance, detailForDistance,
} from './TerrainMesh.js?v=20260921163240';
import { scatterTile, stickSlots, stickContext, SCATTER_PASS_A, SCATTER_PASS_B } from './Scatter.js?v=20260921163240';
import { planVillage, buildVillage } from './Village.js?v=20260921163240';
import { Sky } from '../art/Sky.js?v=20260921163240';
import { Ambient } from './Ambient.js?v=20260921163240';
import { MATS, makeTerrainMaterial, makeWaterMaterial, updateWind } from '../art/Materials.js?v=20260921163240';
import { WATER, SKY } from '../art/Palette.js?v=20260921163240';
import { WORLD, RENDER } from '../core/Config.js?v=20260921163240';
import { rollStick } from '../data/StickData.js?v=20260921163240';
import { buildStick } from '../art/StickGen.js?v=20260921163240';
import { MeshBuilder } from '../art/Geo.js?v=20260921163240';
import { clamp, clamp01, lerp, now, Budget, TAU } from '../core/Util.js?v=20260921163240';
