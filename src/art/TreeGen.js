...
import { MeshBuilder, tube, blob, blade, cylinder, smoothPath, rotAxis, perp, norm3 } from './Geo.js?v=20260920180429';
import { BARK, LEAF, MOSS, MUSHROOM, mixHex, tweak, shade } from './Palette.js?v=20260920180429';
